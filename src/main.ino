...
#define PIN_RCSWITCH              3   // RX on nodemcu

//******************************************************************************************
//ESP8266 WiFi Information
//******************************************************************************************
String str_ssid     = "Get-NERSETH";                            //  <---You must edit this line!
String str_password = "123entotre456";                          //  <---You must edit this line!
...
void setup()
{
  ...
  static st::EX_RCSwitch executor3(F("rcswitch1"), PIN_RCSWITCH, "0000011010100110100101100110010110101010100110101010", "0000011010100110100101100110010110101010100101010101", 9, 4, LOW);
